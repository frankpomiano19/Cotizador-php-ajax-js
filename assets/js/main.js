$('document').ready(()=>{
    ...
    function add_to_quote(e) {
        ...
        $.ajax({
            ...
            notify('Hubo un problema con la peticion, intente de nuevo.','danger');
            form.trigger('reset');
        }).always(()=>{
            form.waitMe('hide');
        })
    ...
    //funcion para reiniciar la cotización
    ...
    function save_concept(e) {
        ...
        //Validar el precio
        if(precio < 10){
            notify('Ingresa un precio mayor a $10.00','danger');
            errors++;
        }
