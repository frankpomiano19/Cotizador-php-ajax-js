<?php if (empty($d->items)) : ?>
    <div class="text-center">
        <h3>La cotizacion está vacía</h3>
            ...
            <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <small class="text-muted d-block">
                                <img src="<?php echo IMG . ($item->type === 'producto' ? 'product.png' : 'service.png') ?>" alt="<?php $item->type === 'producto' ? 'Producto' : 'Servicio' ?>" style="width: 15px;">
                                <?php echo $item->type === 'producto' ? 'Producto' : 'Servicio'; ?></small>
                        </td>
                ...
                <tr>
                    <td class="text-right" colspan="5">
                        ...
                        <small class="text-muted"> <?php echo sprintf('Impuestos incluidos %s%% IGV', TAXES_RATE) ?> </small>
                    </td>
                </tr>
            </tbody>
        </table>
